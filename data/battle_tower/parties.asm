...
BattleTowerMons2:
	...
	db WIGGLYTUFF
	db SITRUS_BERRY
	db HYPER_VOICE, BLIZZARD, FIRE_BLAST, ATTRACT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons3:
	...
	db FEAROW
	db BRIGHTPOWDER
	db BRAVE_BIRD, PURSUIT, PECK, DRILL_RUN
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, DRAIN_PUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
...
BattleTowerMons6:
	...
	db HOUNDOOM
	db LUM_BERRY
	db FLAMETHROWER, CRUNCH, NASTY_PLOT, REST
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db UMBREON
	db SITRUS_BERRY
	db MUD_SLAP, LUX_RESTORE, PSYCHIC_M, FAINT_ATTACK
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons7:
	...
	db UMBREON
	db SITRUS_BERRY
	db FAINT_ATTACK, LUX_RESTORE, CURSE, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db UMBREON
	db SITRUS_BERRY
	db LUX_RESTORE, FAINT_ATTACK, PSYCHIC_M, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db VENUSAUR
	db BRIGHTPOWDER
	db SUNNY_DAY, SOLARBEAM, LUX_RESTORE, HYPER_BEAM
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons9:
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, MUD_SLAP, LUX_RESTORE, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db ESPEON
	db SITRUS_BERRY
	db PSYCHIC_M, SHADOW_BALL, SUNNY_DAY, LUX_RESTORE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
BattleTowerMons10:
	...
	db FEAROW
	db KINGS_ROCK
	db DRILL_PECK, STEEL_WING, HYPER_BEAM, DRILL_RUN
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
