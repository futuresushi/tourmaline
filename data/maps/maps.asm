...
MapGroup_Ecruteak:
	map EcruteakTinTowerEntrance, TILESET_TOWER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ABANDONED_SHIP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map EcruteakPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_FRIENDLY_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map DanceTheatre, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
