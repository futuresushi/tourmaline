...
FalknerGroup:
	...
	db  7, PIDGEY,     TACKLE, MUD_SLAP, AERIAL_ACE, NO_MOVE
	db  9, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, AERIAL_ACE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1), to be replaced
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, JIGGLYPUFF, DOUBLESLAP, DAZZLINGLEAM, ECHOED_VOICE, METRONOME
...
BugsyGroup:
	...
	db 16, YANMA,      QUICK_ATTACK, ECHOLOCATE, SIGNAL_BEAM, NO_MOVE
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, SHADOW_CLAW, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, SHADOW_CLAW, NIGHT_SHADE
	db -1 ; end
...
PryceGroup:
	...
	db 31, PILOSWINE,  ICY_WIND, ICICLE_CRASH, MIST, BLIZZARD
	db -1 ; end
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   BULK_UP, RAGE, KARATE_CHOP, FURY_SWIPES
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, POWER_WHIP, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, POWER_WHIP, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, POWER_WHIP, DRAGON_PULSE
...
Rival1Group:
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, ICE_SHARD
...
WillGroup:
	...
	db 41, JYNX,       DOUBLESLAP, SING, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, EXPLOSION, PSYCHIC_M
	db 41, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, XATU,       QUICK_ATTACK, FUTURE_SIGHT, CALM_MIND, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, SUBMISSION, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	db 42, VILEPLUME,  STUN_SPORE, ACID, LUX_RESTORE, PETAL_DANCE
	db 45, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 47, HOUNDOOM,   ROAR, NASTY_PLOT, FLAMETHROWER, CRUNCH
	db -1 ; end
...
BrockGroup:
	...
	db 41, RHYHORN,    MEGAHORN, SCARY_FACE, EARTHQUAKE, BASS_TREMOR
	db 42, OMASTAR,    BITE, SURF, PROTECT, ICICLE_SPEAR
	db 44, ONIX,       WRAP, ROCK_SLIDE, ENDURE, SANDSTORM
...
ErikaGroup:
	...
	db 41, JUMPLUFF,   ABSORB, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, LUX_RESTORE, ACID, RAZOR_LEAF
	db 46, BELLOSSOM,  SUNNY_DAY, LUX_RESTORE, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
YoungsterGroup:
	...
	db 21, RATICATE,   BITE, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   BITE, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 37, VILEPLUME,  SOLARBEAM, SLEEP_POWDER, ACID, LUX_RESTORE
	db -1 ; end
	...
	db 35, QUAGSIRE,   LEER, BODY_SLAM, AMNESIA, EARTHQUAKE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 40, FARFETCH_D, FURY_SWIPES, PROTECT, FLY, SLASH
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    TOXIC, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    TOXIC, SLUDGE_BOMB, WILL_O_WISP, EXPLOSION
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, X_SCISSOR, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, X_SCISSOR, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, X_SCISSOR, PROTECT
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, DRAGON_PULSE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, SKIPLOOM,   LUX_RESTORE, POISONPOWDER, GIGA_DRAIN, LEECH_SEED
	...
	db 36, RAPIDASH,   STOMP, FIRE_SPIN, FLARE_BLITZ, AGILITY
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, RAPIDASH,   STOMP, FIRE_SPIN, FLARE_BLITZ, AGILITY
	db -1 ; end
	...
	db 43, RAPIDASH,   FOCUS_BAND,   STOMP, FIRE_SPIN, FLARE_BLITZ, FIRE_BLAST
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     LUX_RESTORE, ABSORB, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   LUX_RESTORE, ABSORB, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, ZEN_HEADBUTT, SOFTBOILED
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, MR__MIME,   DAZZLINGLEAM, REFLECT, BATON_PASS, PSYCHIC_M
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   POISON_JAB, FOCUS_ENERGY, TWINEEDLE, RAGE
	...
	db 32, BEEDRILL,   POISON_JAB, PURSUIT, TWINEEDLE, DOUBLE_TEAM
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, MEGAHORN
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, MEGAHORN
	...
	db 39, SEAKING,    ENDURE, FLAIL, MEGAHORN, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, MEGAHORN
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, MEGAHORN
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, MUD_SLAP, DEFENSE_CURL
	db 20, KRABBY,     BUBBLEBEAM, LEER, ROCK_SMASH, DEFENSE_CURL
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 41, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, X_SCISSOR
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, X_SCISSOR
...
HikerGroup:
	...
	db 34, MACHOKE,    KARATE_CHOP, SUBMISSION, HEADBUTT, DIG
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, SLUDGE_BOMB, FLAMETHROWER, ROCK_SLIDE
	db 45, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 50, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FLARE_BLITZ, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 24, KOFFING,    TACKLE, TOXIC, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, AGILITY, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 27, HITMONCHAN, DRAIN_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 35, HOUNDOOM,   EMBER, SLUDGE_BOMB, BITE, FAINT_ATTACK
	db -1 ; end
	...
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    TACKLE, TOXIC, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PicnickerGroup:
	...
	db 32, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, ICE_BEAM, BODY_SLAM
	db -1 ; end
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, ENCORE, LUX_RESTORE, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, JIGGLYPUFF, SING, DEFENSE_CURL, ECHOED_VOICE, DISABLE
	db -1 ; end
...
RedGroup:
	...
	db 73, ESPEON,     SIGNAL_BEAM, REFLECT, LUX_RESTORE, PSYCHIC_M
	db 75, SNORLAX,    AMNESIA, SLEEP_TALK, REST, BODY_SLAM
	db 77, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, LUX_RESTORE, SOLARBEAM
	db 77, CHARIZARD,  FLAMETHROWER, AIR_SLASH, DRAGON_CLAW, FIRE_SPIN
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, HURRICANE
	db 54, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,     MEGAHORN, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EXPLOSION, SOLARBEAM
