...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   DOUBLESLAP, DAZZLINGLEAM, ENCORE, METRONOME
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, POWER_WHIP, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, POWER_WHIP, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, POWER_WHIP, DRAGONBREATH
