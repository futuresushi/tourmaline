...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, WILL_O_WISP, EXPLOSION
...
BeautyGroup:
	...
	db 17, HOPPIP,     LUX_RESTORE, TAIL_WHIP, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   LUX_RESTORE, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
RedGroup:
	...
	db 73, ESPEON,     MUD_SLAP, REFLECT, LUX_RESTORE, PSYCHIC_M
