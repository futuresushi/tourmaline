...
DragonClawDescription:
	db   "Slashes the foe with"
	next "long, sharp claws.@"
...
EcholocateDescription:
	db   "Increases ACCURACY"
	next "and SPCL. ATTACK.@"
