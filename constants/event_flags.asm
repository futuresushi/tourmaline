...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM31_AERIAL_ACE
	const EVENT_GOT_TM49_SIGNAL_BEAM
	const EVENT_GOT_TM01_BULK_UP
	const EVENT_GOT_TM45_ECHOED_VOICE
	const EVENT_GOT_TM30_SHADOW_BALL
	const EVENT_GOT_TM23_IRON_TAIL
	const EVENT_GOT_TM16_ICY_WIND
	const EVENT_GOT_TM24_DRAGON_PULSE
...
; Johto story events
	...
	const EVENT_GOT_TM13_HEAT_WAVE_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_TM50_SHADOW_CLAW
...
; Kanto story events
	...
	const EVENT_GOT_TM42_DRILL_RUN
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_TM_ENERGY_BALL
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_DAZZLINGLEAM
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_TM_WILD_CHARGE
	...
	const EVENT_ROUTE_35_TM_X_SCISSOR
