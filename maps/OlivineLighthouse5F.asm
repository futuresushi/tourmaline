...
OlivineLighthouse5FTMDazzlingleam:
...
OlivineLighthouse5F_MapEvents:
	...
	object_event  2, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, OlivineLighthouse5FTMDazzlingleam, EVENT_OLIVINE_LIGHTHOUSE_5F_TM_DAZZLINGLEAM
