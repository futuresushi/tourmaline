...
LakeOfRage_MapEvents:
	...
	object_event 35,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, LakeOfRageTMEnergyBall, EVENT_LAKE_OF_RAGE_TM_ENERGY_BALL
